...
1) Näherung aus dem Positiven $a \geq 0:\quad a = |a|$
   \[
   \left.
   \begin{array}{rl}
       0 &= 2a^2 - 2a\\
   ...
   \right\}\, a = \{0,\: 1\}
   \]
2) Näherung aus dem Negativen $a < 0:\quad a = -|a| \Leftrightarrow -a = |a|$
   \[
   \left.
   \begin{array}{rl}
       0 &= 2a^2 - a - (-a)\\
...
abline(h = 0, col = "red")
text(label="grenzwert", col = "red", y = 0, x = 2)
abline(h=e, col = "red", lty = 2)
text(label="epsilon", col = "red", y = e, x = 8)
abline(h=-e, col = "red", lty = 2)
text(label="epsilon", col = "red", y = -e, x = 8)
```
