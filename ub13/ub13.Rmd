...
\[
\begin{array}{rl}
    f(x)&=(1-4 x)^{-1} \\ f^{\prime}(x)&=-4(1-4 x)^{-2} \\
...
\begin{align}
    x_0 = 0
    \Rightarrow f(x) &= \sum_{n=0}^\infty 4^n n! x^n\\
    \text{Quotienten:}& \lim_{n\rightarrow \infty} \left| \frac{4^{n+1} (n+1)! x^{n+1} }{4^n n! x^n} \right|\\
    &= \lim_{n\rightarrow \infty} \left| 4(n+1)x \right|\\
    &= \lim_{n\rightarrow \infty} 4(n+1)|x| = \infty\\
    \Rightarrow & r=0
\end{align}
\]
