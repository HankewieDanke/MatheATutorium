...
Es gelte:
$$
u=\left(\begin{array}{l}{0} \\ {1} \\ {1}\end{array}\right) \quad v=\left(\begin{array}{l}{1} \\ {1} \\ {0}\end{array}\right) \quad w=\left(\begin{array}{l}{0} \\ {0} \\ {0}\end{array}\right)
$$
...
$$v \in \mathbb{R}^3 \quad \Rightarrow \text{span}(v) \leq \mathbb{R}^3$$
Daraus folgt: $\dim\text{span}(v) \leq 3$.
