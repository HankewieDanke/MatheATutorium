...
![](Gaußsche_Zahlenebene.png){width=300pt height=100pt}
...
![](Trigonometrie.png){width=300pt height=100pt}
...
\right)
\]
Hierbei ist nun: $EI = A^{-1}$ und wir können somit das Gleichungssystem $x = bA^{-1}$
lösen.
